...
class Ms_defender_controller extends Module_controller
{
    ...
    {
        jsonView(
            Ms_defender_model::selectRaw('healthy, engine_version, definitions_updated, definitions_version, real_time_protection_available, real_time_protection_enabled, org_id, machine_guid, cloud_enabled, cloud_automatic_sample_submission, cloud_diagnostic_enabled, licensed, log_level, release_ring, erd_machine_id, erd_early_preview_enabled')
